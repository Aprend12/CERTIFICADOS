    ...
    <div style="width: 100%; min-height: 27.94cm; padding: 25px; font-family: 'Times New Roman', Times, serif; font-size: 10pt; line-height: 1.5; box-sizing: border-box; background: white;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 12px; font-size: 8pt;">
        <tr style="background: #e0e0e0;">
          ...
          <th style="padding: 4px; border: 0.5pt solid black; text-align: center;">Código</th>
          <th style="padding: 4px; border: 0.5pt solid black; text-align: center;">Horario</th>
        </tr>
        <tr>
          <td style="padding: 3px; border: 0.5pt solid black;">Desarrollo de Software III</td>
          <td style="padding: 3px; border: 0.5pt solid black; text-align: center;">DSW-301</td>
          <td style="padding: 3px; border: 0.5pt solid black; text-align: center;">Sáb 7:00-12:00</td>
        </tr>
        <tr>
          <td style="padding: 3px; border: 0.5pt solid black;">Base de Datos II</td>
          <td style="padding: 3px; border: 0.5pt solid black; text-align: center;">BD-201</td>
          <td style="padding: 3px; border: 0.5pt solid black; text-align: center;">Sáb 13:00-16:00</td>
        </tr>
      </table>
