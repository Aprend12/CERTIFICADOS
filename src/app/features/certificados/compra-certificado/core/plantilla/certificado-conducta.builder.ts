  ...
  build(datos: DatosCertificado): string {
    ...
    <div style="width: 100%; min-height: 27.94cm; padding: 50px 60px; font-family: 'Times New Roman', serif; font-size: 11pt; line-height: 2; box-sizing: border-box; background: #fefefe; position: relative;">
      ...
      <div style="margin-bottom: 25px; text-align: justify; text-indent: 2cm;">
        ...
        <p style="margin-bottom: 15px; color: #2c2c2c; text-indent: 0cm;">Que, <strong style="color: #333333;">*********</strong>, identificado(a) con cédula de ciudadanía No. <strong style="color: #333333;">***********</strong>, cursó el <strong style="color: #333333;">**************** semestre</strong> en el programa de <strong style="color: #333333;">************</strong>, según Snies <strong style="color: #333333;">***********</strong>.</p>
        <p style="margin-bottom: 15px; color: #2c2c2c; padding: 15px; background: #f0f7ff; border-left: 4px solid #e67300; border-radius: 0 8px 8px 0;">Durante el tiempo de permanencia en nuestra institución, el/la estudiante presentó una <strong style="color: #333333;">excelente conducta académica y personal</strong>, demostrando valores éticos y profesionales destacados.</p>
      </div>
